...
* @author GRIP
*/
public class LiftTracker implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 2.7777777777777777;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step RGB_Threshold0:
		Mat rgbThresholdInput = blurOutput;
		double[] rgbThresholdRed = {248.92501894972006, 255.0};
		double[] rgbThresholdGreen = {248.9886002473437, 255.0};
		double[] rgbThresholdBlue = {246.44110958922326, 255.0};
		...
		double filterContoursMaxWidth = 40.0;
