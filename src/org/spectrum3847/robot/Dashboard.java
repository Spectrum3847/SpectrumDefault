...
public class Dashboard {                                                                        
    ...
    private static void updatePutShort() {                                                      
        ...
        SmartDashboard.putNumber("Tilt Error", Robot.shooterWheelFrontTilt.getError());         
    	                                                                                        
        SmartDashboard.putNumber("Flat Speed", Robot.shooterWheelFrontFlat.getSpeed());         
    	SmartDashboard.putNumber("Flat Error", Robot.shooterWheelFrontFlat.getError());         
    	                                                                                        
    	SmartDashboard.putNumber("Middle Speed", Robot.shooterWheelMiddle.getSpeed());          
    	SmartDashboard.putNumber("Middle Error", Robot.shooterWheelMiddle.getError());          
    	                                                                                        
    	SmartDashboard.putNumber("rear Speed", Robot.shooterWheelRear.getSpeed());              
    	SmartDashboard.putNumber("rear Error", Robot.shooterWheelRear.getError());              
